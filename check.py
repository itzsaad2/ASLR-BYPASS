...
'''
check.py
A simple autograder that you can use to check the answers to the lab.
...
def main():
    ...
    if args.part == '2a' or args.part == 'all':
        ...
        points_possible += 10
        if check("part2/a", 1000, b"UofT{nic3_s0lv3!}", 0.50):
            points += 10
    if args.part == '2b' or args.part == 'all':
        ...
        points_possible += 20
        if check("part2/b", 1000, b"UofT{lab_p4rtTw0_1s_d0n3}", 0.50):
            points += 20
    if args.part == '3' or args.part == 'all':
        print("Checking part 3...")
        points_possible += 10
        os.chdir('part3')
        if check("part3", 1000, b"UofT{and_thats_all_folks!}", 0.50):
            points += 10
    
    print(f"Your score is {points} / {points_possible}")

    if args.part == 'all':
        print(f"You scored {(100.0 * points) / points_possible}% for the lab!")
